  ...
  return (
    <div className="w-full text-white py-10  ">
      ...
      <div className="pb-10  px-10">
        <div className="card  mt-10 w-full flex gap-10 ">
          <div className="cardcontainer relative w-1/2  h-[80vh]">
            ...
            <h1 className="absolute top-[50%] z-999 left-full text-6xl text-[#CDEA68]  font-bold translate-x-[-50%] translate-y-[50%]">
              <h1 className="absolute   right-full text-6xl text-[#CDEA68]  font-bold translate-x-[63%]   translate-y-[50%]">
          ...
          <div className=" cardcontainer  w-1/2  h-[80vh]">
            <div className="  flex relative align-center  gap-3">
              <h1 className="absolute top-[40vh]  right-full text-6xl text-[#CDEA68]  font-bold translate-x-[31%]   translate-y-[50%]">
                {" "}
